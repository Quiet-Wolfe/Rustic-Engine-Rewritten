...
use crate::sserafim_lip_sync::{load_sserafim_lip_sync, SserafimLipSyncOverlay};
...
impl AnimateCharacterSprite {
    ...
    pub(crate) fn command_for_overlay_part(
        &self,
        pose: &AnimateCharacterPose,
...
pub(crate) fn load_animate_atlas(
    device: &wgpu::Device,
    queue: &wgpu::Queue,
    resolver: &OverlayResolver,
...
#[derive(Debug, Clone)]
pub(crate) struct LoadedAnimateAtlas {
    pub(crate) texture_id: AssetId,
    flat_labels: Option<FlatLabelAtlas>,
    pub(crate) animation: AnimateAnimation,
    pub(crate) atlas: AnimateAtlas,
}
...
#[derive(Debug, Clone)]
pub(crate) struct AnimateCharacterPose {
